...
export const TableRow: React.FC<TableRowProps> = ({
  ...
  return (
    ...
    <div
      ...
      tabIndex={0}
    >
      <div className={`flex-shrink-0 w-13 bg-background border-r ${isRowActive ? '' : 'border-b border-border/30'} flex items-center justify-center relative select-none gap-2`} style={{ height: '40px', position: 'sticky', left: 0, zIndex: 11, boxShadow: '2px 0 4px -2px rgba(0,0,0,0.06)', boxSizing: 'border-box' }}>
