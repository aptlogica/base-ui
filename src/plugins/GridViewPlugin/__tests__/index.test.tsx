...
describe('GridViewPlugin', () => {
  ...
  beforeEach(() => {
    ...
    mockUseGridData.mockReturnValue({
      ...
      bulkUpdateColumn: { mutate: vi.fn(), mutateAsync: vi.fn() } as any,
  ...
  describe('GridView component', () => {
    ...
    it('should display loading state', () => {
      mockUseGridData.mockReturnValue({
        ...
        bulkUpdateColumn: { mutateAsync: vi.fn(), isPending: false, isError: false, isSuccess: false, error: null, data: undefined } as any,
    ...
    it('should render Table component when data is loaded', async () => {
      const mockActions = {
        ...
        bulkUpdateColumn: { mutateAsync: vi.fn(), isPending: false, isError: false, isSuccess: false, error: null, data: undefined },
