...
const MainCard: React.FC<MainCardProps> = ({ icon, title, desc, onClick, iconColor = 'text-gray-800' }) => (
  <div
    className="flex flex-col items-start bg-card rounded-lg shadow-sm border px-6 py-5 min-w-[240px] flex-1 cursor-pointer hover:shadow-md transition-all duration-200"
    onClick={onClick}
  >
