...
export declare class TableService {
     ...
     */
    bulkDeleteRow(params: types.BulkDeleteRow): Promise<import("..").StandardResponse<any>>;
    /**
     * Insert row data
     ...
     */
    getBulkAssets(params: types.GetBulkAssets | assetTypes.GetBulkAssets): Promise<import("..").StandardResponse<any>>;
    /**
     * Update asset metadata
     * PATCH /asset/:id
     */
    updateAssetById(id: string, params: assetTypes.UpdateAsset): Promise<import("..").StandardResponse<any>>;
    /**
     * Delete asset
     * DELETE /asset/:id
     */
